...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_stash__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_stash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_stash__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_stash___default.a);
...
var _storeAccessor = __webpack_require__(12);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-688a7855", Component.options)
  } else {
    hotAPI.reload("data-v-688a7855", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        startMovieUpdateTimeout: function startMovieUpdateTimeout() {
            ...
            this.movieUpdateTimeout = setTimeout(function () {
                _this.updateMovies();
            }, 500);
        },
        getGenres: function getGenres() {
            ...
            axios.get(this.config.urls.api + 'genres').then(function (res) {
        ...
        changeMovie: function changeMovie(_movieID) {
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "filter" }, [
      ...
      _c("div", [
        ...
        _c(
          ...
          _vm._l(_vm.pages, function(_page) {
            return _c("option", { domProps: { value: _page } }, [
              _vm._v(_vm._s(_page))
            ])
          })
        ),
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm._l(_vm.genres, function(_genre) {
            return _c(
              "button",
              {
                class: "" + (_vm.genre == _genre ? "active" : ""),
                on: {
                  click: function($event) {
                    _vm.changeGenre(_genre)
                  }
                }
              },
              [_vm._v(_vm._s(_genre))]
            )
          })
        ],
        2
    ...
    _vm._v(" "),
    _c("div", { class: "player" + (_vm.video != null ? " visible" : "") }, [
      _vm.video != null
        ? _c("div", [
            _c("video", {
              attrs: { src: _vm.video, autoplay: "", controls: "" }
            })
          ])
        : _vm._e(),
      _vm._v(" "),
      _c(
        "button",
        { staticClass: "btn-close", on: { click: _vm.closeVideo } },
        [_vm._v("×")]
      )
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "moviethumbs" }, [
      _c(
        "div",
        {
          staticClass: "moviethumbs__wrapper",
          style: "width: " + _vm.movies.length * 97 + "px"
        },
        _vm._l(_vm.movies, function(movie, _movieID) {
          return _c(
            "button",
            {
              class:
                "movie-thumb" + (_movieID == _vm.movieID ? " current" : ""),
              on: {
                click: function($event) {
                  _vm.changeMovie(_movieID)
                }
              }
            },
    ...
    _vm._v(" "),
    _c("div", { staticClass: "moviedescription" }, [
      typeof _vm.movies[_vm.movieID] !== "undefined"
        ? _c(
            "div",
            { staticClass: "moviedescription__inner" },
            [
              _c("h2", [
                _vm._v(_vm._s(_vm.movies[_vm.movieID].title) + " "),
                _c("span", [
                  _vm._v("(" + _vm._s(_vm.movies[_vm.movieID].year) + ")")
                ])
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v(
                  _vm._s(
                    _vm.movies[_vm.movieID].description.replace(
                      "Fehler Melden",
                      ""
                    )
                  )
              ...
              _vm._v(" "),
              _c("h4", [_vm._v("Streams")]),
              _vm._v(" "),
              _vm._l(_vm.movies[_vm.movieID].streamurls, function(
                stream,
                index
              ) {
                return _c(
                  ...
                  [_vm._v("Stream " + _vm._s(index + 1))]
                )
              }),
              _vm._v(" "),
              _c("h4", [_vm._v("Trailer")]),
              _vm._v(" "),
              _c("iframe", {
                attrs: {
                  src: _vm.movies[_vm.movieID].trailer.replace(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-688a7855", module.exports)
  }
}
